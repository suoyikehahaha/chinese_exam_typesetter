"""Cancellable preview service using the complete v0.4.1 renderer."""
...
from .internal_preview_v041 import render_internal_preview
...
class PreviewService:
    """Run one complete internal preview task and discard stale generations."""
