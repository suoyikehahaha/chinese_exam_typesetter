...
"""Production one-file Windows v0.4.1 build."""
...
hiddenimports = [
    ...
    "app.preview_service_v041",
    *collect_submodules("tkinter"),
]

a = Analysis(
    [str(project_root / "windows_launcher_v041_final.py")],
...
exe = EXE(
    ...
    a.datas,
    [],
    name="ChineseExamTypesetter_0.4.1",
    debug=False,
