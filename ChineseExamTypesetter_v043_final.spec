...
"""Production one-file Windows v0.4.3 build."""
...
hiddenimports = [
    "desktop_app_v043",
    "desktop_app_v041",
    "desktop_app_v04_final",
    "desktop_app_v04_stable",
    "desktop_app_v04_release",
    "desktop_app_v04",
    "desktop_app_v03",
    "desktop_app_current_v01",
    "app.inspector_model_v04",
    "app.read_only_preview_v04",
    "app.current_pipeline_v04",
    "app.page_layout_v04",
    "app.chinese_line_break_v042",
    "app.font_resolver_v043",
    "app.internal_preview_v041",
    "app.internal_preview_v043",
    "app.preview_service_v043",
    *collect_submodules("tkinter"),
]

a = Analysis(
    [str(project_root / "windows_launcher_v043_final.py")],
...
exe = EXE(
    ...
    a.datas,
    [],
    name="ChineseExamTypesetter_0.4.3",
    debug=False,
