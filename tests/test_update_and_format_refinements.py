...
from app.publication_note_formatting import apply_publication_note_formatting
from app.flexible_importers import (
    PUBLICATION_NOTE_RE,
    mark_publication_notes,
)
from app.windows_activation import ACTIVE, INACTIVE
...
def test_contextual_formatting_applies_simsun_right_alignment(tmp_path) -> None:
    ...
    apply_publication_note_formatting(target, raw)
