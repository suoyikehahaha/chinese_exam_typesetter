"""Coverage for the v0.3 editable document and score model."""
...
from app.editable_a4_canvas_v03 import block_editor_text, question_editor_lines
from app.score_summary_v03 import calculate_score_summary, format_score


ROOT = Path(__file__).resolve().parents[1]


class EditableScoresV03Tests(unittest.TestCase):
    def setUp(self) -> None:
        self.raw = json.loads(
    ...
    def test_v03_entry_imports_without_starting_tk(self) -> None:
        import desktop_app_v03

        self.assertEqual(desktop_app_v03.APP_VERSION, "0.3.0")

    def test_pagination_signature_skips_rebuild(self) -> None:
        from app.editable_a4_canvas_v03 import EditableA4Canvas
