...
_ORIGINAL_VISUAL_LOADER = v02._load_source_visuals
    ...
    for row in rows or [[""]]:
        ...
        for index in range(columns):
            ...
            for paragraph in value.splitlines() or [""]:
                lines.extend(v02._wrap_text(scratch, paragraph, font, max(20, column_width - 2 * padding)))
            lines = lines or [""]
...
def render_internal_preview(
    ...
    with _PATCH_LOCK:
        previous_loader = v02._load_source_visuals
        previous_marker = v02._NATIVE_DRAWING_RE
        v02._load_source_visuals = _load_source_visuals
        v02._NATIVE_DRAWING_RE = _NATIVE_OBJECT_RE
        try:
            return v02.render_internal_preview(prepared, layout_path, output_dir)
        finally:
            v02._load_source_visuals = previous_loader
            v02._NATIVE_DRAWING_RE = previous_marker
