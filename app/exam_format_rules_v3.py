"""Final fixed rules for stems, options, subquestions and notices."""
...
def apply_exam_format_rules_v3(docx_path: str | Path) -> None:
    """Apply fixed indent rules with a visible 1.5-character option offset."""
    ...
    for paragraph in _all_paragraphs(document):
        ...
        if OPTION_RE.match(text):
            paragraph.paragraph_format.left_indent = Pt(size * (1.5 + 1.7))
