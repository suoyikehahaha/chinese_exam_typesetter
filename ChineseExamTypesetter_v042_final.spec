...
"""Production one-file Windows v0.4.2 build."""
...
hiddenimports = [
    ...
    "app.internal_preview_v042",
    "app.preview_service_v042",
    *collect_submodules("tkinter"),
]

a = Analysis(
    [str(project_root / "windows_launcher_v042_final.py")],
...
exe = EXE(
    ...
    a.datas,
    [],
    name="ChineseExamTypesetter_0.4.2",
    debug=False,
