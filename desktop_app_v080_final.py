"""Final v0.8.0 entry with protected source character decorations."""
...
from app.flexible_importers_v6 import import_exam
...
def build_documents_v8_final(
    ...
    *,
    ...
    """Render, restore protected marks, then create the silent preview."""
