"""Cancellable, Office-independent preview generation for runtime 0.2."""
...
from .internal_preview_v02 import render_internal_preview
...
class PreviewService:
    """Run one internal preview task and discard stale generations."""
    ...
    def submit(
        ...
        """Submit a lightweight preview and invoke ``callback`` once."""
