...
def apply_contextual_formatting_v11(
    docx_path: str | Path,
    ...
    apply_contextual_formatting_v10(target, raw_exam)
    normalize_header_v11(target, raw_exam)


def normalize_header_v11(
    docx_path: str | Path,
    raw_exam: dict[str, Any],
) -> None:
...
__all__ = [
    "apply_contextual_formatting_v11",
    "normalize_header_v11",
]
