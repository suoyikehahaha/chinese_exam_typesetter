...
from .contextual_formatting_v7 import apply_contextual_formatting_v7


def apply_contextual_formatting_v8(
    docx_path: str | Path,
    ...
    apply_contextual_formatting_v7(target, raw_exam)
...
__all__ = ["apply_contextual_formatting_v8"]
