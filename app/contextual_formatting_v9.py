...
from .contextual_formatting_v8 import apply_contextual_formatting_v8


def apply_contextual_formatting_v9(
    docx_path: str | Path,
    ...
    apply_contextual_formatting_v8(target, raw_exam)
...
__all__ = ["apply_contextual_formatting_v9"]
