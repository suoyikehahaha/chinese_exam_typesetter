...
from .regional_header_formatting import apply_regional_header_formatting
...
def apply_notice_material_formatting(
    docx_path: str | Path,
    ...
    apply_regional_header_formatting(target, raw_exam)
...
__all__ = ["apply_notice_material_formatting"]
